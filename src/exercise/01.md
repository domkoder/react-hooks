...
1. I learned how use react hook to change the state of my app using the
   useState() that receive the initial state value and return 2 output. The
   state variable and setState() function.
