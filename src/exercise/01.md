...
1. I learned how to use react hook to change the state of my app using the
   useState() that receive the initial state value and return array with 2
   values. The state variable and setState() function.
2. Also learned why react hooks was introduce to react and what problems they
   where trying solve with react hooks.
