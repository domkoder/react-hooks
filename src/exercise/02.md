...
1. I learned how to use the useEffect hooks to get data stored in localStorage.
   react hooks runs after the component renders or re-renders it collect a call
   back function as an argument.
2. I learned about lazy state initialization and how it can help boost the
   performance of my app. reading from localStorage is slow and could be
   problematic.
3. I learned about effect dependencies, useEffect collects a second argument
   which is an array of dependencies. dependencies can be of any length
   depending on what you are using inside the uesEffect.
4. I learned how to use custom hooks to reuse complicated code or reusable cod.
5. I learned about react hooks flow and how component is been rendered to the
   screen.
