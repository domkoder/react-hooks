...
1. Managed State: This are state that you need to explicitly manage
2. Derived State: State that you can calculate base on other state preserved
   state in localStorage using custom hooks (useLocalStorageState) adde game
   history feature.
