...
1. Lifting state can help the performance of any react app it basically means
   push up the state to the common parent shared between the two components and
   manage the state there.
2. Collocating state is the opposite of lifting state it basically means push
   down the state to the closest component that need it.
